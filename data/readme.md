# Annual CO₂ emissions from coal - Data package

This data package contains the data that powers the chart ["Annual CO₂ emissions from coal"](https://ourworldindata.org/grapher/annual-co2-coal?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on November 25, 2025.
...
#### Full citation
Global Carbon Budget (2025) – with major processing by Our World in Data. “Annual CO₂ emissions from coal” [dataset]. Global Carbon Project, “Global Carbon Budget v15” [original data].
